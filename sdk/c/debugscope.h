...
#define DSCOPE(key, value) _Generic((value), \
    bool: ds_bool,                          \
    signed char: ds_i32,                   \
    unsigned char: ds_u32,                 \
    short: ds_i32,                         \
    unsigned short: ds_u32,                \
    int: ds_i32,                           \
    unsigned int: ds_u32,                  \
    long: ds_i64,                          \
    unsigned long: ds_u64,                 \
    long long: ds_i64,                     \
    unsigned long long: ds_u64,            \
    float: ds_f32,                         \
    double: ds_f64                         \
)(key, value)
#else
#define DSCOPE(key, value) ((void)0)
#endif
